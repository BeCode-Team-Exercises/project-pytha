<?php
include "../model/GamePlanet.php";
// Creates connection with GamePlanet database
$GamePlanet = new videogames;

// Games to add!
$diablo2 = createPlatforms("diablo2","Diablo 2","20","Blizzard Entertainment","Blizzard San Francisco", "1", "13", "3348542160316", "10", "Diablo, the Lord of Terror, has fallen to a brave hero beneath the church of Tristram. Now that hero is gone, replaced by a Dark Wanderer who roams the world of Sanctuary leaving death and destruction in his wake. As a hero of humanity, you must face the minions of Diablo's evil brothers and stop the Dark Wanderer before he fulfills his terrible destiny.");
...
function createPlatforms($arrayofgames, $gamename, $price, $publisher, $dev, $platform , $pegi, $ean, $stock, $description){
    ...
    $platforms = array();
    switch($platform){
        case "1": array_push($platforms, "PC");
        break;
        case "2": array_push($platforms, "Xbox One");
        break;
        case "3": array_push($platforms, "Playstation 4");
        break;
        case "4": array_push($platforms, "Nintendo Switch");
        break;
        case "5": array_push($platforms, "Xbox One");
        array_push($platforms, "Playstation 4");
        break;
        case "6": array_push($platforms, "Xbox One");
        array_push($platforms, "Playstation 4");
        array_push($platforms, "Nintendo Switch");
        break;
        case "7": array_push($platforms, "PC");
        array_push($platforms, "Playstation 4");
        array_push($platforms, "Xbox One");
        break;
        case "8": array_push($platforms, "PC");
        array_push($platforms, "Xbox One");
        break;
        case "9": array_push($platforms, "PC");
        array_push($platforms, "Playstation 4");
        break;
    }
